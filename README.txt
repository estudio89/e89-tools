...
1. No arquivo settings.py, adicionar "e89_tools" na lista de INSTALLED_APPS.
1. Inserir no arquivo settings.py as opções de configuração explicadas em sequência.
1. Rodar ./manage.py migrate para criar tabela de KeyValueStore.
